...
```html
https://acdn.adnxs.com/as/1h/pages/motorsport-total.js
```

With the following AdLib JS-Url:

```html
https://www.asadcdn.com/adlib/pages/motorsport-total.js
```
...
<link rel="preconnect" href="//www.asadcdn.com"/><link rel="dns-prefetch" href="//www.asadcdn.com"/>
```

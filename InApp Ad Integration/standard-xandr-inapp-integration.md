...
| [publisherId]                  | The ID of your publisher in the Xandr Ad Server. <br>If you don't know this id, you can ask Ad Technology for help. | yes      |
| [gdpr]                         | The `gdpr` keyword is part of the european privacy law ["GDPR"](https://gdpr.eu/what-is-gdpr/).<br>This keyword always has the value `0` for users outside the EU, while it has the value `1` for users within the EU.<br><br>. | yes      |

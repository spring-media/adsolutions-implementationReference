...
| [publisherId]                  | The ID of your publisher in the Xandr Ad Server. <br>If you don't know this id, you can ask Ad Technology for help. | yes      |
| [gdpr_applies]                 | The GDPR_APPLIES keyword is part of the european privacy law ["GDPR"](https://gdpr.eu/what-is-gdpr/).<br>This keyword always has the value `0` for users outside the EU, while it has the value `1` for users within the EU.<br><br>You can get the proper value from the CMP object to append it here as parameter. | yes      |
